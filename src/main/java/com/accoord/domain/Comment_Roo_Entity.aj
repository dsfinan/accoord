...
privileged aspect Comment_Roo_Entity {
    ...
    public static long Comment.countComments() {
        return entityManager().createQuery("select count(o) from com.accoord.domain.Comment o", Long.class).getSingleResult();
    }
    
    public static List<Comment> Comment.findAllComments() {
        return entityManager().createQuery("select o from com.accoord.domain.Comment o", Comment.class).getResultList();
    }
    ...
    public static List<Comment> Comment.findCommentEntries(int firstResult, int maxResults) {
        return entityManager().createQuery("select o from com.accoord.domain.Comment o", Comment.class).setFirstResult(firstResult).setMaxResults(maxResults).getResultList();
    }
