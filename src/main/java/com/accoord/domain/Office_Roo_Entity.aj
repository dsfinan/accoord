...
privileged aspect Office_Roo_Entity {
    ...
    public static long Office.countOffices() {
        return entityManager().createQuery("select count(o) from com.accoord.domain.Office o", Long.class).getSingleResult();
    }
    
    public static List<Office> Office.findAllOffices() {
        return entityManager().createQuery("select o from com.accoord.domain.Office o", Office.class).getResultList();
    }
    ...
    public static List<Office> Office.findOfficeEntries(int firstResult, int maxResults) {
        return entityManager().createQuery("select o from com.accoord.domain.Office o", Office.class).setFirstResult(firstResult).setMaxResults(maxResults).getResultList();
    }
