...
privileged aspect Message_Roo_Entity {
    ...
    public static long Message.countMessages() {
        return entityManager().createQuery("select count(o) from com.accoord.domain.Message o", Long.class).getSingleResult();
    }
    
    public static List<Message> Message.findAllMessages() {
        return entityManager().createQuery("select o from com.accoord.domain.Message o order by o.created asc", Message.class).getResultList();
    }
    ...
    public static List<Message> Message.findMessageEntries(int firstResult, int maxResults) {
        return entityManager().createQuery("select o from com.accoord.domain.Message o", Message.class).setFirstResult(firstResult).setMaxResults(maxResults).getResultList();
    }
