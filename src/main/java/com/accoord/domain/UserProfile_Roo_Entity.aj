...
privileged aspect UserProfile_Roo_Entity {
    ...
    public void UserProfile.remove() {
        ...
        if (this.entityManager.contains(this)) {
            ...
            UserProfile attached = this.entityManager.find(this.getClass(), this.id);
    ...
    public static long UserProfile.countUserProfiles() {
        return entityManager().createQuery("select count(o) from com.accoord.domain.UserProfile o", Long.class).getSingleResult();
    }
    
    public static List<UserProfile> UserProfile.findAllUserProfiles() {
        return entityManager().createQuery("select o from com.accoord.domain.UserProfile o", UserProfile.class).getResultList();
    }
    ...
    public static List<UserProfile> UserProfile.findUserProfileEntries(int firstResult, int maxResults) {
        return entityManager().createQuery("select o from com.accoord.domain.UserProfile o", UserProfile.class).setFirstResult(firstResult).setMaxResults(maxResults).getResultList();
    }
