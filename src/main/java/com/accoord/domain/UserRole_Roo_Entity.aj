...
privileged aspect UserRole_Roo_Entity {
    ...
    public void UserRole.remove() {
        ...
        if (this.entityManager.contains(this)) {
            ...
            UserRole attached = this.entityManager.find(this.getClass(), this.id);
    ...
    public static long UserRole.countUserRoles() {
        return entityManager().createQuery("select count(o) from com.accoord.domain.UserRole o", Long.class).getSingleResult();
    }
    
    public static List<UserRole> UserRole.findAllUserRoles() {
        return entityManager().createQuery("select o from com.accoord.domain.UserRole o", UserRole.class).getResultList();
    }
    ...
    public static List<UserRole> UserRole.findUserRoleEntries(int firstResult, int maxResults) {
        return entityManager().createQuery("select o from com.accoord.domain.UserRole o", UserRole.class).setFirstResult(firstResult).setMaxResults(maxResults).getResultList();
    }
